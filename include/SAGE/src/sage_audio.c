...
/**
 * AHI calls this player hook normally, even when it runs from its audio timing.
 * Do not mark it as INTERRUPT: amiga-gcc would emit RTE instead of RTS.
 */
ASM static void SAGE_PTPlayer(
