...
extern BOOL ASM mt_init(REG(a2, struct PTData *));
extern BOOL ASM mt_start(REG(a2, struct PTData *));
extern BOOL ASM mt_resume(REG(a2, struct PTData *));
extern void ASM mt_stop(REG(a2, struct PTData *));
extern void ASM mt_end(REG(a2, struct PTData *));
extern void ASM mt_music(REG(a2, struct PTData *));
